...
import {
  ...
  DynamicField
} from '../../../../../shared/components/dynamic-display/dynamic-display.component';
...
@Component({
  selector: 'app-task-approved',
  standalone: true,
  imports: [
    CommonModule,
    DynamicDisplayComponent
  ],
  templateUrl: './task-approved.component.html',
  styleUrl: './task-approved.component.scss'
})
export class TaskApprovedComponent implements OnInit {
  // ========================================
  // PROPRIEDADES
  // ========================================

  userData: User | null = null;
  apiData: TaskApproved[] = [];
