...
@Component({
  selector: 'app-approver-contract',
  imports: [CommonModule],
  templateUrl: './approver-contract.component.html',
  styleUrl: './approver-contract.component.scss'
})
export class ApproverContractComponent implements OnInit {
